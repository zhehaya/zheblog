  ...
  <div class="wcowin-header-avatar">
    <div class="flip-glow-ultimate">
      ...
      <div class="flip-glow-ultimate-imgs">
        <img src="image/头像2.jpg" alt="zhehaya头像背面" class="flip-glow-ultimate-front" loading="eager" fetchpriority="high" width="260" height="260">
        <img src="image/头像.png" alt="zhehaya头像正面" class="flip-glow-ultimate-back" loading="lazy" width="260" height="260">
      </div>
    </div>
  </div>
</div>
